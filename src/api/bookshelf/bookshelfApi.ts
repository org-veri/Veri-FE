import { API_BASE_URL, makeApiRequest, type BaseApiResponse } from '../apiClient';
...
export const getAllBooks = async (
  ...
  const url = new URL('/api/bookshelf/my', API_BASE_URL);
...
export const searchBooksByTitle = async (query: string): Promise<SearchBooksResponse> => {
  const url = new URL('/api/bookshelf/search', API_BASE_URL);
...
export const getPopularBooks = async (
  ...
  const url = new URL('/api/bookshelf/popular', API_BASE_URL);
  if (params.page !== undefined) url.searchParams.append('page', String(params.page));
  if (params.size !== undefined) url.searchParams.append('size', String(params.size));
...
export const searchMyBook = async (
  ...
  const url = new URL('/api/bookshelf/my/search', API_BASE_URL);
...
export const updateBookVisibility = async (
  ...
  const url = new URL(`/api/bookshelf/${readingId}/visibility`, API_BASE_URL);
